...
app = typer.Typer(help="Search and browse Location Areas (Pokemon encounter spots).")
console = Console()
...
def get(
    ctx: typer.Context,
    name_or_id: str = typer.Argument(..., help="Location area name or ID"),
    no_cache: bool = typer.Option(False, "--no-cache", help="Skip local cache"),
    format: str = typer.Option(
        "table", "--format", help="Output format: table or json"
    ),
) -> None:
    """Get details about a Location Area (includes Pokemon encounter table)."""
